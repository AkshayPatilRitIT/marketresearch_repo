...
import { storeSampleRequestData } from '../../../Service/storeSampleRequestData'
import "../Report.css"
...
export default class RequestSample extends Component {
    render() {
        return (
            <div style={{ margin: "30px" }}>
                <div className="Report__inquery__title">Request sample</div>
                <div className="Report__inquery__wrapper">
                    <Formik
                        ...
                        onSubmit={async values => {
                            ...
                            let result = await storeSampleRequestData(data)
                        ...
                        {({ errors, touched, handleChange, handleBlur }) => (
                            <Form>
                                ...
                                <div className="Report__field__body">
                                    ...
                                    <div className="Report__field__body__input">
                                        <Field name="designation" placeholder="Title/Designation" className="Report__iquery__field" />
